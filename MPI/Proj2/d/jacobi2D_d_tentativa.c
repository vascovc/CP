...
int main(int argc, char *argv[])
{
    ...
    MPI_Datatype columnSkip;
    MPI_Type_vector((myrows + 2)/2, 1, 2*(mycols + 2) , MPI_DOUBLE, &columnSkip);
    MPI_Type_commit(&columnSkip);

    MPI_Datatype rowSkip;
    MPI_Type_vector((mycols + 2)/2, 1, 2 , MPI_DOUBLE, &rowSkip);
    MPI_Type_commit(&rowSkip);
    ...
    for (int iter = 0; iter < MAXIT; iter++)
    {
        ...
        int ii0 = 1;
        int jj0 = 1;
        if (((firstcol + jj0 - 1)  + (firstrow + ii0 - 1)) %2 != 0)
        {
            jj0++;
        }
        ...
        int ii1 = myrows + 1 ;
        int jj1 = 1;
        if (((firstcol + jj1 - 1)  + (firstrow + ii1 - 1)) %2 != 0)
        {
            jj1++;
        }
         
        MPI_Sendrecv(&Vnew[ii0][jj0], 1, rowSkip, nbrbottom, 4, &Vnew[ii1][jj1], 1, rowSkip, nbrtop, 4, comm2D, MPI_STATUS_IGNORE);
        ...
        MPI_Sendrecv(&Vnew[ii0][jj0], 1, rowSkip, nbrtop, 5, &Vnew[ii1][jj1], 1, rowSkip, nbrbottom, 5, comm2D, MPI_STATUS_IGNORE);
        ...
        MPI_Sendrecv(&Vnew[ii0][jj0], 1, columnSkip, nbrleft, 6, &Vnew[ii1][jj1], 1, columnSkip, nbrright, 6, comm2D, MPI_STATUS_IGNORE);
        ...
        MPI_Sendrecv(&Vnew[ii0][jj0], 1, columnSkip, nbrright, 7, &Vnew[ii1][jj1], 1, columnSkip, nbrleft, 7, comm2D, MPI_STATUS_IGNORE);
        ...
        MPI_Sendrecv(&Vnew[ii0][jj0], 1, rowSkip, nbrbottom, 8, &Vnew[ii1][jj1], 1, rowSkip, nbrtop, 8, comm2D, MPI_STATUS_IGNORE);
        ...
        MPI_Sendrecv(&Vnew[ii0][jj0], 1, rowSkip, nbrtop, 9, &Vnew[ii1][jj1], 1, rowSkip, nbrbottom, 9, comm2D, MPI_STATUS_IGNORE);
        ...
        MPI_Sendrecv(&Vnew[ii0][jj0], 1, columnSkip, nbrleft, 10, &Vnew[ii1][jj1], 1, columnSkip, nbrright, 10, comm2D, MPI_STATUS_IGNORE);
        ...
        MPI_Sendrecv(&Vnew[ii0][jj0], 1, columnSkip, nbrright, 11, &Vnew[ii1][jj1], 1, columnSkip, nbrleft, 11, comm2D, MPI_STATUS_IGNORE);
    ...
    MPI_Type_free(&columnSkip);
    MPI_Type_free(&rowSkip);
