                        ...
                        pixel_t *h_odata)
{
    ...
    if (nonmaxflag)
    {
        ...
        //nonMaximumSupression_CUDA<<<grid_size,block_size>>>(cuda_h_idata, aux, cuda_h_odata, w, h, th_count);
...
int main( int argc, char** argv) 
{
    ...
    int deviceId = 1; // o 0 acaba por ser melhor mas n esta a funcionar
