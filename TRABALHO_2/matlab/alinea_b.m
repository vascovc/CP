...
for k = 1:itermax
    for i = 1:N
        for j = 1:N
            ...
            V_new(i,j)= 0.25*(V_old(i_0,j)+V_old(i_1,j)+V_old(i,j_0)+V_old(i,j_1)-h^2*f);
        end
    end
...
saveas(gcf,'MPI_alinea_b.png','png')
